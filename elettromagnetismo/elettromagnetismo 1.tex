...
\section{Elettrostatica nel vuoto}	
	\subsection{Forza elettrica tra due cariche (legge di Coulomb)}
...
\section{Aspetti energetici e III equazione di maxwell}
	\subsection{Lavoro, potenziale e energia elettrostatica}
 	$L_{AB}=\int_A^B\!\mathbf F\cdot\mathrm d\mathbf s=q\int_A^B\!\mathbf E \cdot\de\mathbf s=-q\int_A^B \vec\nabla V\cdot\de\mathbf s=-q\int_A^B\de V$\\
...
\section{Magnetostatica nel vuoto}
	\subsection{Campo di induzione magnetica (legge di Ampère)}
	\begin{tabular}{@{}ll}
	...
	\begin{tabular}{@{}ll}
		...
		$\de\mathbf B(\mathbf r) = \frac{\mu_0}{4\pi} \frac{\mathbf J(\mathbf r^\prime) \de\upsilon^\prime \times (\mathbf r-\mathbf r^\prime)}{|\mathbf r-\mathbf r^\prime|^3}$\end{tabular}
...
%		$\dive\,\mathbf E_0(\mathbf r,t)=\frac{1}{\varepsilon_0}\varrho(\mathbf r,t)$&$\dive\,\mathbf B_0(\mathbf r,t)=0$\\
...
%	$\frac{\de}{\mathrm dt}\int_\Upsilon\varrho\,\de\upsilon=\int_{\partial\Upsilon}\mathbf J\cdot(-\mathbf n)\,\mathrm dS\qquad \frac{\partial\varrho}{\partial t}+\dive\mathbf J=0$\\\smallskip
%   
